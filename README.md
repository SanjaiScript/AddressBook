...
Description :
-------------------------------------------------------------------------------
The Address Book Management System is a C-based application designed to
efficiently manage personal or organizational contacts. The program provides
functionality for creating, viewing, searching, editing, and deleting contact
information, which is stored persistently in a CSV file.
